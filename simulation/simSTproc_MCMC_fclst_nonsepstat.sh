...
# matlab -nodesktop -nodisplay < simSTproc_MCMC_fclst_nonsepstat.m > simSTproc_MCMC_fclst_nonsepstat.out &
mcc -m simSTproc_MCMC_fclst_nonsepstat.m -I ~/Projects/STGP/code/simulation -I ~/Projects/STGP/code/sampler -I ~/Projects/STGP/code/util -I ~/Projects/STGP/code/util/mtimesx -I ~/Projects/STGP/code/util/STGP_mtimesx;
chmod +x ./run_simSTproc_MCMC_fclst_nonsepstat.sh
./run_simSTproc_MCMC_fclst_nonsepstat.sh ${MCRROOT} $num_trl $stationary $mdl_opt $upthypr [] $intM $hold_out $spdapx $seedNO

# ./simSTproc_MCMC_fclst_nonsepstat
# submit:
# sbatch --export=num_trl=100,stationary=0,mdl_opt=0,upthypr=1,intM=0,hold_out=0,spdapx=0,seedNO=2018 --job-name=sim3K100 --output=sim3K100.log simSTproc_MCMC_fclst_nonsepstat.sh