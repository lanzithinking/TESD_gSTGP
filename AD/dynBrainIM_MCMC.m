...
yy=cell2mat(shiftdim(y,-3)); % MRI images need to standize the sizes
if d==2
...
s=2; % smoothness
kappa=1; % decaying rate for dynamic eigenvalues
% graph kernel
...
stgp=feval([stgp_ver,'.hd'],ker{1},ker{2},Lambda,kappa,mdl_opt); [ker{1:2}]=deal([]);
