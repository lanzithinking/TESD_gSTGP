...
mcc -m dynBrainIM_MCMC_fclst.m -I ~/STGP/code/AD -I ~/STGP/code/util -I ~/STGP/code/sampler -I ~/STGP/code/util/STGP_mtimesx/ -I ~/STGP/code/util/mtimesx/ -I ~/STGP/code/util/Image_Graphs/;
chmod +x ./run_dynBrainIM_MCMC_fclst.sh
./run_dynBrainIM_MCMC_fclst.sh /usr/local/matlab/R2018b $grp_opt $mdl_opt [] [] [] $intM

# ./dynBrainIM_MCMC_fclst
# submit:
# qsub -v grp_opt=1,mdl_opt=2,intM=1 -N CN-intM -q stat dynBrainIM_MCMC_fclst.sh